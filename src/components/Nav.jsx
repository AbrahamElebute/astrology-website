...
const Nav = () => {
  ...
  const navigation = [
    ...
    { title: "Create Chart", path: "javascript:void(0)", isDrapdown: false },
        ...
        <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <a href="javascript:void(0)">
              <img src={LogoTransparent} width={120} height={50} alt="" />
            </a>
                ...
                return (
                  <li key={idx}>
                    ...
                    drapdownState.isActive ? (
                      <div className="mt-6 inset-x-0 top-[65px] w-full md:absolute md:border-y md:shadow-md md:mt-0 bg-white">
